...
CREATE TABLE `estados` (
  `id` int(11) NOT NULL, -- Identificador único do estado
  `nome` varchar(75) DEFAULT NULL, -- Nome do estado
  `uf` varchar(2) DEFAULT NULL, -- Sigla do estado
  `ibge` int(2) DEFAULT NULL, -- Código IBGE do estado
  `pais` int(3) DEFAULT NULL, -- Identificador do país
  `ddd` varchar(50) DEFAULT NULL -- Códigos DDD associados ao estado
